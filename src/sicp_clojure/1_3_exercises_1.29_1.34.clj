...
(t/deftest tests
  (t/is (< (m/abs (- 0.25 (simpson-integral s/cube 0 1 100))) 0.001))
  (t/is (< (m/abs (- 0.25 (simpson-integral s/cube 0 1 1000))) 0.001))
  ...
  (t/is (< (m/abs (- Math/PI (pi-approx 1000))) 0.01))
  (t/is (= 1 (factorial-iter 0)))
  (t/is (= 1 (factorial-iter 1)))
  (t/is (= 2 (factorial-iter 2)))
  (t/is (= 120 (factorial-iter 5)))
  (t/is (< (m/abs (- 1 (geometric-sum 1/2 1/2 50))) 0.01))
  (t/is (< (m/abs (- 1 (sine-product (/ Math/PI 2) 100))) 0.01))
  (t/is (< (m/abs (- 1 (sine-product (/ Math/PI 2) 1000))) 0.01))
  (t/is (< (m/abs (- 0.707106781 (sine-product* (/ Math/PI 4) 1000))) 0.01))
