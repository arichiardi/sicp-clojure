(ns sicp-clojure.1-2-exercises-1-09-1-14
...
;; for (A 3 3) one additional level of convolution is applied every time x is incremented:
...
(t/deftest tests
  (t/is (= (m/expt 2 10) (A 1 10))) ;; 2^n
  (t/is (= (m/expt 2 (m/expt 2 (m/expt 2 2))) (A 2 4))) ;; 2^(2^2^...) for y-1 times
